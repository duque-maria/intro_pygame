...
while 1:
    ...
    #Dibujar formas con el módulo pygame.draw
    ...
    # True: crea un polígono (une los puntos)
    puntos1 = [(0,0), (50,100), (100,50), (250,200), (400,400)]
    puntos2 = [(200,0), (400,200), (200,400), (0,200)]
    pygame.draw.lines(ventana, azul, False, puntos1)
    pygame.draw.lines(ventana, rojo, True, puntos2)

    # Dibujar un rectángulo
    # Rectángulo relleno, ubicado en la coordenada esquina sup. izq. (200,200), y de ancho 200 y altura 100
    pygame.draw.rect(ventana, rosado, (200,200, 200,100))
    # Rectángulo sin relleno, esquina sup. izq: (100,100), esquina inf. der: (150,200) Y de grosor 1.
    ...
    # Dibujar un círculo
    # Centro del círculo: (300,100)
    # Radio del círculo: 100
    # Grosor contorno del círculo: 1
    ...
    pygame.draw.arc(ventana, cian, (300, 25, 100, 150), PI/2, PI, 1)
    
    # Texto
    # Fuente de tipo Arial, tamaño 35, negrilla y cursiva.
    fuente_arial = pygame.font.SysFont("Arial", 35, 1, 1)
    texto = fuente_arial.render("Sistemas Guanentá", 1, blanco)
